...
<head>
    ...
    <title>Blog Detail | Mediatech</title>
...
<body class="bg-white">
    ...
    <section class="w-full flex justify-center items-center pt-24 sm:pt-28 md:pt-32">
        <div class="flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 px-4 md:px-6 w-full max-w-[90rem]">
            <div class="flex flex-col justify-center items-center gap-2">
                ...
                <p class="opacity-80 text-gray-900 text-xs sm:text-sm md:text-base">
                    Oleh : Wiradarma A.
                </p>
            </div>
    ...
    <!-- HERO -->
    <!-- MAIN BLOGS -->
    <main class="w-full flex justify-center items-center my-3 sm:my-6 md:my-8">
        <div class="flex flex-col justify-start items-start gap-1 sm:gap-2 max-w-6xl w-full px-4 md:px-6">
            <h2 class="text-gray-900 font-semibold text-lg md:text-xl lg:text-2xl mt-1 sm:mt-2 leading-snug">Lorem ipsum dolor sit amet consectetur.</h2>
            <p class="opacity-80 text-gray-900 text-xs sm:text-sm md:text-base">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nesciunt sint dolore asperiores tempora iure possimus odit sed, minima ducimus, nemo autem sunt, dolorem cumque. Beatae nam praesentium odio, harum eum totam accusantium, iure unde sequi ipsam accusamus numquam, laborum laudantium.
            </p>
            <p class="opacity-80 text-gray-900 text-xs sm:text-sm md:text-base">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis delectus inventore, veniam vero labore pariatur iusto, impedit, corrupti autem quia consectetur suscipit!</p>
            <h2 class="text-gray-900 font-semibold text-lg md:text-xl lg:text-2xl mt-1 sm:mt-2 leading-snug">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2>
            <p class="opacity-80 text-gray-900 text-xs sm:text-sm md:text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque distinctio eligendi recusandae perferendis, ducimus reprehenderit maxime, dignissimos alias illum soluta nostrum! Iusto et consectetur numquam voluptatum? Iure voluptatum velit dolore debitis adipisci culpa accusamus aspernatur labore! Praesentium numquam id corporis!</p>
            <h2 class="text-gray-900 font-semibold text-lg md:text-xl lg:text-2xl mt-1 sm:mt-2 leading-snug">Lorem ipsum dolor sit amet consectetur.</h2>
            ...
            <h2 class="text-gray-900 font-semibold text-lg md:text-xl lg:text-2xl mt-1 sm:mt-2 leading-snug">Lorem ipsum dolor sit amet consectetur.</h2>
            <p class="opacity-80 text-gray-900 text-xs sm:text-sm md:text-base">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi veritatis exercitationem delectus nostrum dolorem, deserunt deleniti? Fuga totam mollitia nihil inventore at quis nam consequuntur nisi recusandae, impedit dolorem nesciunt sequi in assumenda sint similique vero rem nobis quos quod.</p>
            <p class="opacity-80 text-gray-900 text-xs sm:text-sm md:text-base">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus laborum fugiat expedita quibusdam aspernatur rerum enim? Nemo suscipit aliquid libero iste? Possimus quibusdam placeat perspiciatis.</p>
        </div>
    </main>
    <!-- MAIN BLOGS -->
